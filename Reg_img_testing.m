function [MOVINGREG] = Reg_img_testing(MOVING,FIXED)%,ROI,idx,FIXED)
...
% Auto-generated by registrationEstimator app on 06-Apr-2020
%-----------------------------------------------------------
...
% Match features
indexPairs = matchFeatures(fixedFeatures,movingFeatures,'MatchThreshold',31.712963,'MaxRatio',0.317130);
